...
import markit.email.dtos.ConfirmVerificationRequest;
import markit.email.dtos.FindIdResponse;
import markit.email.dtos.PasswordResetRequest;
import markit.email.dtos.PasswordResetTokenResponse;
import markit.email.dtos.SendPasswordResetCodeRequest;
